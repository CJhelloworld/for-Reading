...
#define  ADC_LED_RING		2048 //RGB灯坏模块的R1:R2 = 4.7K :4.7K
#define  ADC_CAMERA			4095 //摄像头模块的R1 = 10K 
#define  ADC_MODULE1		1310 //模块1的R1:R2 = 4.7K :10K
#define  ADC_MODULE2		2786 //模块2的R1:R2 = 10K :4.7K
